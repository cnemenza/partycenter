...
const NotFoundResult = ({ title, text, href }: NotFoundProps) => {
  return (
    <div className='w-full flex flex-col items-center text-center gap-3'>
      ...
      <div className='text-xl font-extrabold mt-2'>{title ? title : '404'}</div>
      <div className='text-base'>{text ? text : 'Sorry, the requested resource does not exist.'}</div>
      {href && (
        <div className='text-lg'>
          <Button asChild>
            <Link href={href}>
              <HiOutlineArrowSmLeft className='h-5 w-5' /> Back
            </Link>
          </Button>
        </div>
      )}
